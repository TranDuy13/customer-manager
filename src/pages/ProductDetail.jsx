                        ...
                        <div className="w-[50%] mr-[25px]">
                            <div className="">
                                <img
                                    ...
                                    src="https://bizweb.dktcdn.net/thumb/grande/100/199/851/products/44083-61020-70zv-2-kawasaki-pump-39-5-kg-46-copy-result.jpg?v=1652065969137"
                                    alt=""
                                />
                            </div>
                        </div>
                        <div className="w-[50%] mr-[25px] min-w-[280px]">
                            <div className="">
                                ...
                                <div className="mt-[10px] flex justify-between">
                                    <div>
                                        Nhãn hiệu: <span className="font-bold">Kawasaki</span>
                                    </div>
                                    <div>
                                        SKU: <span className="font-bold">44083-61020</span>
                                    </div>
                                </div>
                                <div className="mt-[10px] flex justify-between">
                                    <div>
                                ...
                                <div className="mt-[10px] flex justify-between">
                                    <div>
                                        ...
                                        <span className="italic ">
                                            Tên sản phẩm: 44083-61020 Bơm Thủy Lực Máy Xúc Kawasaki Thuộc: Thiết bị: Bộ
                                            phận thủy lực Tên hãng: Phụ Tùng KAWASAKI Danh Điểm P/N: 44083-61020 Mode
                                            xe: Mô tả: Trọng Lượng: 0(Kg/Pce)
                                        </span>
                                    </div>
                                </div>
                    ...
                    <div className="mt-[30px]">
                        ...
                        <div className="border-[1px] p-5">
                            ...
                            <div>
                                <img
                                    className="w-[70%]"
                                    src="https://bizweb.dktcdn.net/100/199/851/files/44083-61020-70zv-2-kawasaki-pump-39-5-kg-47-copy-result.jpg?v=1652065944044"
                                    alt=""
                                />
                            </div>
                            <div>
